...
2. Clone the repository: `git clone https://github.com/bi83ga/IoT-Device-Monitor.git`
3. Navigate to the project directory.
4. Run `dotnet build` to build the project.
5. Run `dotnet run --project src/IoTDeviceMonitor.csproj` to start the application.
6. Follow the menu prompts to manage devices.
